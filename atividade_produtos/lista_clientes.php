...
<body>
    <div class="container">
        ...
        <?php if($_SESSION['nivel_acesso'] == "ADMINISTRADOR"){
            echo '<a href="cadastrar.php" class="btn btn-success mb-3">Cadastrar Cliente</a>';
        }?>
            ...
            <tbody>
                <?php foreach ($clientes as $cliente):?>
                    <tr>
                        ...
                        <a href="excluir.php?id=<?= $cliente['id'] ?>" class="btn btn-warning" onclick="return confirm('A exclusão será permanente! Tem certeza disso?')">Excluir</a>
                        <?php else: ?>
